...
/**
 * Write a description of class lab2.dc.unifil.br.TabelaTempos here.
 * 
 * @author (your name) 
...
public class TabelaTempos
{
    ...
    public void exibirGraficoXY() {
        ...
        System.out.println("num coluna: "+ numColunas);
    ...
    public void graficoComparativo() {

    }


    /**
     * ele conta o numero max de coluna
     *
     * @return retorna o numero max
     */
    ...
    private LinkedList<double[]> tabela = new LinkedList<>();
}
